#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_aux.c,v 1.13 92/10/21 16:36:06 sam Exp $";
#endif
...
/*	case TIFFTAG_TILEDEPTH:
		*va_arg(ap, u_long *) = td->td_tiledepth;
		return (1);*/  /* SGI private tag */
/*	case TIFFTAG_DATATYPE:
		*va_arg(ap, u_short *) = td->44td_sampleformat-1;
		return (1);*/  /* SGI private tag */
