#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/libtiff/RCS/tif_dir.c,v 1.120 92/11/03 09:47:30 sam Exp $";
#endif
...
/*  case TIFFTAG_TILEDEPTH:
        ...
        td->td_tiledepth = v;
        break;*/ /* SGI private tag */
/*  case TIFFTAG_DATATYPE:*/  /* SGI private tag */
    case TIFFTAG_SAMPLEFORMAT:
        v = va_arg(ap, int);
        /*if (tag == TIFFTAG_DATATYPE && v == 0)
            v = SAMPLEFORMAT_VOID;*/ /* SGI private tag */
